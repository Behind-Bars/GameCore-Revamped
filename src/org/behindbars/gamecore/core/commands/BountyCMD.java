...
public class BountyCMD extends Command {

	private static String name = "bounty";
	...
	public boolean execute(CommandSender sender, String commandLabel, String[] args) {
		...
		player.sendMessage(Main.getColorHandler().message + "Command is currently unavailable.");
